...
type SettingsInternalPatch struct {
	...
	SendHookSniffWebhookHeaders        *bool                                 `json:"sendHookSniffWebhookHeaders,omitempty"`
	ShowFeatureTooltips           *bool                                 `json:"showFeatureTooltips,omitempty"`
	ShowUseHookSniffPlay               *bool                                 `json:"showUseHookSniffPlay,omitempty"`
...
func (o SettingsInternalPatch) MarshalJSON() ([]byte, error) {
	...
	if o.SendHookSniffWebhookHeaders != nil {
		toSerialize["sendHookSniffWebhookHeaders"] = o.SendHookSniffWebhookHeaders
	}
	if o.ShowFeatureTooltips != nil {
		toSerialize["showFeatureTooltips"] = o.ShowFeatureTooltips
	}
	if o.ShowUseHookSniffPlay != nil {
		toSerialize["showUseHookSniffPlay"] = o.ShowUseHookSniffPlay
	}
